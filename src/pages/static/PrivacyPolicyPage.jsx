    ...
    >
      ...
      <div className="max-w-3xl mx-auto space-y-10">
        ...
        <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-lg">
          ...
          This policy explains what data we collect, how we use it, and how you can 
          manage your information. Our mission is to give you a safe, secure, and 
          transparent note-taking experience.
        </p>
        ...
        <section>
          ...
          <ul className="list-disc ml-6 space-y-2 text-gray-600 dark:text-gray-400">
            <li>
              <strong>Account Information:</strong> Your name, email, and login credentials 
              for authentication and access management.
            </li>
            <li>
              <strong>Notes & Documents:</strong> All content you create and store in Notexa 
              is encrypted and securely synced across your devices.
            </li>
            <li>
              <strong>Usage Data:</strong> Anonymous analytics like app performance, device type, 
              and feature usage to enhance your experience.
            </li>
            <li>
              <strong>Cookies:</strong> Minimal cookies are used to maintain your login session 
              and remember preferences (e.g., dark mode).
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
            ...
            digital system is 100% secure, we continuously monitor and update our 
        ...
        <section>
          ...
          <ul className="list-disc ml-6 space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <li>Contact us for clarification or complaints about data handling</li>
          </ul>
        </section>
