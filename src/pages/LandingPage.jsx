  ...
  const features = [
    {
      ...
      description: "Get intelligent suggestions and content enhancements powered by advanced AI algorithms that learn your writing style.",
      highlights: ["Smart content suggestions", "Auto-completion", "Style analysis"]
    },
    {
      icon: <Zap className="w-12 h-12" />,
      title: "Lightning Fast Sync",
      description: "Experience blazing fast note creation and retrieval with our cloud-optimized architecture and real-time synchronization.",
      highlights: ["Instant sync", "Offline access", "Quick search"]
    },
    {
      icon: <Shield className="w-12 h-12" />,
      title: "Military-Grade Security",
      description: "Your notes are encrypted end-to-end with AES-256 encryption. Your privacy and data security are our top priority.",
      highlights: ["End-to-end encryption", "Two-factor auth", "Privacy first"]
    },
    {
      icon: <Palette className="w-12 h-12" />,
      title: "Beautiful Customization",
      description: "Personalize your writing experience with themes, fonts, and layouts that inspire creativity and focus.",
      highlights: ["Multiple themes", "Custom fonts", "Flexible layouts"]
    },
    {
      icon: <Search className="w-12 h-12" />,
      title: "Smart Search & Organization",
      description: "Find anything instantly with AI-powered search that understands context and relationships between your notes.",
      highlights: ["AI search", "Smart tags", "Quick filters"]
    },
    {
      icon: <Users className="w-12 h-12" />,
      title: "Collaborative Editing",
      description: "Work together seamlessly with real-time collaboration, comments, and version history for team projects.",
  ...
  const testimonials = [
    {
      ...
      content: "Neuctra Notes has transformed how I organize my thoughts. The AI features are incredibly useful for brainstorming and content creation!",
      avatar: "/avatar-1.jpg",
      rating: 5
    },
    {
      ...
      content: "I've tried dozens of note apps, but none combine simplicity and power like Neuctra Notes. The sync is flawless across all my devices.",
      avatar: "/avatar-2.jpg",
      rating: 5
    },
    {
      ...
      content: "The dark mode is perfect for my late-night writing sessions. My productivity has doubled since switching to Neuctra Notes!",
      avatar: "/avatar-3.jpg",
      rating: 5
    },
    {
      ...
      content: "The AI writing assistant has saved me hours of work. It's like having a creative partner that never gets tired.",
      avatar: "/avatar-4.jpg",
      rating: 5
    }
  ];
  ...
  const faqs = [
    {
      ...
      answer: "Our AI analyzes your writing style and content to provide relevant suggestions, completions, and improvements in real-time."
    },
    {
      question: "Is my data secure and private?",
      answer: "Yes, all your notes are encrypted end-to-end. We never access your content and adhere to strict privacy standards."
    },
    {
      question: "Can I use Neuctra Notes offline?",
      answer: "Absolutely! All notes are available offline and automatically sync when you're back online."
    },
    {
      question: "What platforms are supported?",
      answer: "Neuctra Notes is available on Web, iOS, Android, Windows, and macOS with seamless sync across all devices."
    }
  ];
  ...
  const pricingPlans = [
    {
      ...
      features: ["Up to 100 notes", "Basic AI features", "1GB storage", "Web & mobile apps"],
      cta: "Get Started",
      popular: false
    },
    {
      ...
      features: ["Unlimited notes", "Advanced AI features", "50GB storage", "All platforms", "Priority support", "Custom themes"],
    ...
    },
    {
      ...
      features: ["Everything in Pro", "Team workspaces", "Admin controls", "Advanced analytics", "SSO integration", "99.9% uptime SLA"],
      cta: "Contact Sales",
      popular: false
    }
  ];
  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col bg-gradient-to-br from-emerald-50 via-white to-green-50 dark:from-zinc-950 dark:via-zinc-900 dark:to-emerald-950 text-gray-900 dark:text-white transition-all duration-300">
            ...
            <div className="flex justify-between items-center">
              ...
              <Link to="/" className="flex items-center space-x-3 group">
                <div className="relative">
                  ...
                  <div className="relative bg-white dark:bg-zinc-800 rounded-2xl p-2 shadow-lg">
                    <img
        ...
        <section className="relative flex-1 flex flex-col items-center justify-center text-center px-4 sm:px-6 pt-32 pb-20">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 mb-10 max-w-3xl mx-auto leading-relaxed">
              Neuctra Notes helps you capture, organize, and enhance your ideas with built-in AI. 
              <span className="font-semibold text-emerald-600 dark:text-emerald-400"> Cultivate your thoughts</span> and watch them transform into something extraordinary.
            </p>
          ...
          <div className="container mx-auto max-w-7xl">
            <div className="text-center mb-20">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
                Everything you need to capture, organize, and bring your ideas to life
              </p>
            </div>
        ...
        <section id="testimonials" className="py-20 px-4 sm:px-6 bg-emerald-50 dark:bg-emerald-900/10">
          <div className="container mx-auto max-w-6xl">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                Join our community of productive users who trust Neuctra Notes with their ideas
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-emerald-600 via-green-600 to-emerald-500 rounded-3xl p-12 sm:p-16 shadow-2xl relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-emerald-100 text-lg sm:text-xl mb-8 max-w-2xl mx-auto leading-relaxed">
                  Join thousands of productive users growing their ideas with AI-powered Neuctra Notes
                </p>
          ...
          <div className="container mx-auto px-4 sm:px-6 py-12">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="md:col-span-2">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-6 max-w-md">
                  The intelligent note-taking app that helps you capture, organize, and bring your ideas to life with AI assistance.
                </p>
            ...
            <div className="border-t border-emerald-100 dark:border-emerald-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex space-x-6 text-sm">
                <a href="#" className="text-gray-500 dark:text-gray-400 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">
                  Privacy Policy
                </a>
                <a href="#" className="text-gray-500 dark:text-gray-400 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">
                  Terms of Service
