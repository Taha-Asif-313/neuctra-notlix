...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-emerald-50 to-green-50 dark:from-zinc-950 dark:to-green-950 text-gray-900 dark:text-white !!transition-all duration-300">
      ...
      >
        <div className="container mx-auto px-6 flex justify-between items-center">
          <Link to="/" className="flex-shrink-0 flex items-center z-10">
            ...
            <span className="hidden sm:block text-sm font-bold bg-clip-text text-transparent bg-primary">
              Neuctra{" "}
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className="p-2 rounded-full bg-white dark:bg-primary/60 shadow-md hover:shadow-lg !transition-all hover:scale-110"
      ...
      <main className="relative flex-1 flex flex-col items-center justify-center text-center px-6 pt-24 pb-16">
        <div className="max-w-4xl mx-auto">
          <div className="inline-flex items-center gap-2 bg-primary/5 dark:bg-primary/10 text-primary dark:text-primary px-4 py-2 rounded-full mb-6 text-sm font-medium">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-300 mb-10 max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            <Link
              to="/create"
              className="flex items-center justify-center gap-2 px-8 py-2 bg-gradient-to-r from-emerald-600 to-primary text-white rounded-lg shadow-lg hover:shadow-xl !transition-all hover:scale-105 group"
            >
              <Sprout size={20} />
              Try AI Note
              <MoveRight
            ...
            <Link
              to="/home"
              className="px-8 py-2 border border-gray-300 dark:border-primary rounded-lg hover:bg-white dark:hover:bg-primary/50 !transition-all"
            >
              View Notes
            </Link>
          </div>
          ...
          <div className="animate-bounce flex justify-center mt-8">
            <ChevronDown className="text-primary dark:text-primary" />
          </div>
        </div>
