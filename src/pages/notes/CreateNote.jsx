...
const CreateNote = () => {
  ...
  const BottomNavigation = () => (
    <div
      className={`fixed lg:max-w-4xl mx-auto border-2 rounded-lg bottom-0 left-0 right-0 bg-white/95 dark:bg-zinc-900/95 backdrop-blur-lg border-t border-gray-200/60 dark:border-zinc-700/60 z-40 safe-area-bottom ${
